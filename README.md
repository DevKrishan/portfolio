...
I build products at the intersection of AI and real user pain. My work lives in walking prototypes, shipped features, and measurable outcomes — not slide decks. Every product decision I make is grounded in discovery, shaped by data, and pressure-tested against the people who actually use it.
...
## 🧩 Walking Prototypes — My Living Specs

I build fully interactive prototypes that engineering, design, sales, and leadership can open in a browser and walk through end-to-end. The prototype *is* the spec — ambiguity gets resolved before sprint planning, not mid-sprint.

| Prototype | Link |
|-----------|------|
| 🤖 SparrowGenie (full product) | [sparrowgenie.netlify.app](https://sparrowgenie.netlify.app/) |
| 📊 Proposal Engagement Dashboard | [figma.site →](https://free-admin-57678777.figma.site/) |
| 🏠 Home Dashboard (Polished) | [figma.site →](https://lovely-dairy-78049841.figma.site/) |
| 🏠 Home Dashboard (Latest) | [figma.site →](https://aloha-jungle-69298189.figma.site/) |
...
| 🔐 Login Portal | [figma.site →](https://edit-plasma-21481919.figma.site/) |
